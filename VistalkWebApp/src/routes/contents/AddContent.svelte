  ...
  <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
      ...
      >
          <div class="flex items-center justify-between space-x-4">
              <h1 class="text-xl font-medium text-gray-800">{isAdd ? "Create content" : "Edit content"}</h1>
                ...
                <div>
                      <div class="flex flex-col items-left gap-6 mt-16">
                        <div class="flex gap-4">
                          ...
                          <div class="mt-2">  
                            <label class="inline-flex items-center cursor-pointer">
                                <input bind:checked={content.content.forPronunciation} type="checkbox" class="sr-only peer">
                                <div class="relative w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-700 
                                  peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full 
                                  peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] 
                                  after:start-[2px] after:bg-white after:border-gray-300 after:border 
                                ...
                                <span class="ms-3 text-sm font-medium text-black dark:text-black">For Pronunciation</span>
                            </label>
                          </div>
