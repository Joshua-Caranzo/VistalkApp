...
{#if showUnits}
 ...
 <div class="gap-4 flex flex-col sm:flex-row justify-between items-center mt-1 bg-white rounded-xl py-4 px-4 shadow-lg">
    <p class="font-['Helvetica'] text-black text-xl font-bold">Sections</p>

    <div class="flex flex-col sm:flex-row gap-4 mt-4 sm:mt-0">
        <select bind:value={currentValue} on:change={getSectionDisplay} class="font-['Helvetica'] bg-white text-black py-2 px-3 rounded-xl text-sm shadow-lg ">
